...
@Service
@RefreshScope
@RocketMQMessageListener(nameServer = "${rocketmq.name-server}", topic = "${allen.message.forwarding.rocketmq.send.topic}", consumerGroup = "${allen.message.forwarding.rocketmq.send.consumer.group}")
