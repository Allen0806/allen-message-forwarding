...
public class AmfMessageForwardingConfigDO implements Serializable {
	...
	@NotNull(message = "消息配置主键ID不能为空", groups = { Insert.class })
	...
	@NotNull(message = "目标系统名称不能为空", groups = { Insert.class })
	...
	@NotNull(message = "转发到目标系统的方式不能为空", groups = { Insert.class })
	...
	@NotNull(message = "目标地址不能为空", groups = { Insert.class })
	...
	public String toString() {
		...
		sbuilder.append("AmfSourceSystemConfigDO[").append("id=").append(id).append(", messageConfigId=")
				...
				.append(retryTimes).append(", deleted=").append(deleted).append(", createdBy=").append(createdBy)
